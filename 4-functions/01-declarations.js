...
//  4) they can be invoked (used) as many times as we want, cutting down on code reptition
...
console.log(sentence("Ali", "Colglazier"));
console.log(sentence("Amira", "Kupty"));
let superImportantSentence = sentence("Shadi", "Kupty");
